...
const Main = () => {
  return (
    <div className="w-[90%] bg-pink-500/500 h-[65vw] absolute top-6 left-1/2 transform -translate-x-1/2">
      <div className="w-full absolute bg-pink-500/500 flex items-center justify-end">
        ...
        <div className="w-[40%] h-[55%] mb-10 absolute bg-blue-600/600 flex flex-col justify-center pr-10">
          <p className="text-white text-[4vw] font-genos text-center self-end ">From</p>
          <p className="text-white text-[10vw] font-edwardian text-center leading-[2vw]">Gears</p>
          <p className="text-white text-[4vw] font-genos text-center self-end ">to</p>
          <p className="text-white text-[5vw] font-aporo text-center leading-[2vw]">MICRO</p>
          <p className="text-white text-[6vw] font-aporo text-center  self-end ">CHIPS</p>
        </div>
        <div className="absolute self-end w-[38vw] mb-1 flex items-center justify-center">
          ...
          />
          <p className="absolute font-genos text-white text-[2.8vw]">Register Now</p>
        </div>
        ...
        <div className="h-10 flex items-center absolute -bottom-[6vw] right-0 justify-between pl-[3vw] w-[19vw] bg-blue-500/500 px-2">
          <p className="text-[2.3vw] text-[#FFFFFF] font-genos">
            Know More
          </p>
          <Image
            src={knowmore}
