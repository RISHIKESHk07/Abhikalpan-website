...
const EventAccordionItem = ({ title, content, index }: {title:string, content: Array<AccordionSubItem>, index:string}) => {
  return (
        ...
        {content.map((item) => (
          <>
            ...
            <br />
            <p className="font-hellvitica mb-2 text-[#D9D9D9]">{item.subtext}</p>
            <br />
          </>
        ))}
			</AccordionContent>
