...
const clubsData = [
  {
    ...
    description: "Electronics and Robotics Society is the dynamic community of innovators and tech enthusiasts dedicated to exploring the limitless possibilities of electronics and robotics, driving automation, and shaping a smarter, more connected future through hands-on learning and groundbreaking projects.",
    events: [
      {
  ...
  },
  {
    ...
    description: "Astronomy and Physics Society fosters a passion for space and scientific exploration through discussions, workshops, and stargazing events. It brings together students interested in understanding the universe, from fundamental physics to cutting-edge astronomy.",
    events: [
      {
  ...
  },
  {
    ...
    description: "IIITDMJ Racing Club is dedicated to designing and building high-performance vehicles for national competitions. It provides hands-on experience in automotive engineering, aerodynamics, and manufacturing, fostering innovation in motorsports technology",
    events: [
      {
        title: "DRIVELINE",
        content: [
  ...
  },
  {
    ...
    description: "Business and Management Club cultivates entrepreneurial and managerial skills through case studies, market analysis, and business strategy discussions. It organizes workshops, competitions, and networking events to prepare students for leadership roles in the corporate world.",
    events: [
      {
        title: "TRADING EVENT",
        content: [
      ...
      <AccordionContent className="font-aporo text-[20px] text-white">
        {content.map((item) => (
          <>
            ...
            >
              <a href={item.link} className="font-aporo text-[12px] md:text-[14px] text-center text-white leading-[40px] pl-[30px]">
                RULE BOOK
              </a>
            </div> : null}
          </>
